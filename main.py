...
def main():
    ...
    from strategy_config import DEFAULT_CAPITAL, MARKET_ENV_BULL_L0_SCORE, MARKET_ENV_BULL_L1_SCORE
    parser.add_argument("--capital", type=float, default=DEFAULT_CAPITAL, help="总资金（元）")
    ...
    if args.env != "SIDEWAYS":
        ...
        market_env = ("BULL" if l0_status.score >= MARKET_ENV_BULL_L0_SCORE and l1.score >= MARKET_ENV_BULL_L1_SCORE
